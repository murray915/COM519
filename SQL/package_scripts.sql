...
UPDATE packages SET name = ?, description = ?, items_consumed = ?, active_flag = ?, item_qty_consumed = ? WHERE package_id = ?;
INSERT INTO packages (package_id, name, description, items_consumed, active_flag, item_qty_consumed) VALUES (?,?,?,?,?,?);
